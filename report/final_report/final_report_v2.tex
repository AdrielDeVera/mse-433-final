...
Together these define four classes: Smooth (regular, consistent), Erratic (regular, variable), Intermittent (sporadic, consistent), and Lumpy (sporadic, variable---hardest to manage).
...
\textbf{Dependencies} (\texttt{requirements.txt}): \texttt{numpy==2.2.6}, \texttt{pandas==2.3.3}, \texttt{matplotlib==3.10.3}, \texttt{seaborn==0.13.2}, \texttt{streamlit==1.45.1}. The HistogramGBT is implemented entirely in NumPy---no scikit-learn, XGBoost, or LightGBM required.
